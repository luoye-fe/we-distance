...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socket = __webpack_require__(35);

	var _socket2 = _interopRequireDefault(_socket);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	window.Socket = (0, _socket2.default)('');
...
/***/ function(module, exports, __webpack_require__) {
	...
	_vue2.default.filter('toFixed', function (value, input) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _utils.mixin)(state, _common2.default);
...
/***/ function(module, exports) {
	...
	var setWho = exports.setWho = function setWho(store, who) {
		store.dispatch('SETWHO', who);
	};

	var setMLocation = exports.setMLocation = function setMLocation(store, location) {
		store.dispatch('SETMLOCATION', location);
	};

	var setOLocation = exports.setOLocation = function setOLocation(store, location) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _utils.mixin)(mutations, common);
...
/***/ function(module, exports) {
	...
	var SETWHO = exports.SETWHO = function SETWHO(state, who) {
		state.who = who;
	};

	var SETMLOCATION = exports.SETMLOCATION = function SETMLOCATION(state, location) {
		state.mLocation = location;
	};

	var SETOLOCATION = exports.SETOLOCATION = function SETOLOCATION(state, location) {
		state.oLocation = location;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] static/src/js/app.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		name: 'App',
		components: {
			'm-check': _check2.default,
			'm-location': _location2.default,
			'm-map': _map2.default
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] static/src/js/components/check.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./check.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./check.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
		...
		methods: {
			apply: function apply() {
				...
				window.Socket.on('checked', function () {
					_this.showCheck = false;
					_actions2.default.setWho(_store2.default, _this.selected);
				});
			}
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] static/src/js/components/location.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-c9b4c93a/location.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-c9b4c93a&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./location.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-c9b4c93a&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./location.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		vuex: {
			getters: {
				who: function who() {
					return _store2.default.state.who;
				},
				mLocation: function mLocation() {
					return _store2.default.state.mLocation;
				},
				oLocation: function oLocation() {
					return _store2.default.state.oLocation;
				}
			}
		},
		computed: {
			other: function other() {
				var otherWho = this.who === 'him' ? 'her' : 'him';
		...
		ready: function ready() {
			...
			window.Socket.on('send-location-to-clients', function (location) {
				var otherWho = _this.who === 'him' ? 'her' : 'him';
				_actions2.default.setOLocation(_store2.default, {
					x: location[otherWho].x || '',
					y: location[otherWho].y || ''
				});
				_actions2.default.setMLocation(_store2.default, {
					x: location[_this.who].x || '',
					y: location[_this.who].y || ''
				});
			});
			window.Socket.on('checked', function () {
				_this.sendLocation();
			});
			window.Socket.on('other-offline', function () {
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"con\" _v-c9b4c93a=\"\">\n\t<div class=\"mine location-con\" _v-c9b4c93a=\"\">\n\t\t<span _v-c9b4c93a=\"\">我的位置</span>\n\t\t<div class=\"item\" _v-c9b4c93a=\"\">\n\t\t\t<p _v-c9b4c93a=\"\">经度：</p>\n\t\t\t<span _v-c9b4c93a=\"\">{{mLocation.x | toFixed 2}}</span>\n\t\t</div>\n\t\t<div class=\"item\" _v-c9b4c93a=\"\">\n\t\t\t<p _v-c9b4c93a=\"\">纬度：</p>\n\t\t\t<span _v-c9b4c93a=\"\">{{mLocation.y | toFixed 2}}</span>\n\t\t</div>\n\t</div>\n\t<div class=\"other location-con\" _v-c9b4c93a=\"\">\n\t\t<span _v-c9b4c93a=\"\">{{other}}的位置</span>\n\t\t<div class=\"item\" _v-c9b4c93a=\"\">\n\t\t\t<p _v-c9b4c93a=\"\">经度：</p>\n\t\t\t<span _v-c9b4c93a=\"\">{{oLocation.x | toFixed 2}}</span>\n\t\t</div>\n\t\t<div class=\"item\" _v-c9b4c93a=\"\">\n\t\t\t<p _v-c9b4c93a=\"\">纬度：</p>\n\t\t\t<span _v-c9b4c93a=\"\">{{oLocation.y | toFixed 2}}</span>\n\t\t</div>\n\t</div>\n</div>\n<span v-show=\"showOffLine\" _v-c9b4c93a=\"\">对方离线</span>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] static/src/js/components/map.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		ready: function ready() {
			...
			window.Socket.on('send-location-to-clients', function () {
				_this.generateMap();
			});
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (!WebSocket && typeof window === 'undefined') {
	  try {
	    WebSocket = __webpack_require__(73);
	  } catch (e) { }
	}
